                                ...
                                @csrf
                                  <div style="width:100%; display: flex;justify-content:space-around;margin-bottom: 20px">
                                    <div style="width:100%">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="namecategory" type="text" class="form-control" id="company" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" value="{{ $category_room->tenloai }}" required>
                                      ...
                                      <div style="width:100%">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                          <input name="capacity" type="number" min = 1 class="form-control" id="fullName" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" value="{{ $category_room->succhua }}" required>
                                      ...
                                      <div style="width:100%">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                        <input name="area" type="number" min = 20 class ="form-control" id="Country" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" value="{{ $category_room->dientich }}" required>
                                  ...
                                  <div style="width:100%; display: flex;justify-content:space-around;margin-bottom: 50px">
                                    ...
                                    <div style="width:100%">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                        <input name="service" type="text" class ="form-control" id="Country" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" value="{{ $category_room->tienich }}" required>
                                    ...
                                    <div style="width:100%">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                        <input name="interior" type="text" class ="form-control" id="Country" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" value="{{ $category_room->noithat }}" required>
                                    ...
                                    <div style="width:100%">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                        <input name="regulations" type="text" class ="form-control" id="Country" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" value="{{ $category_room->quydinh }}" required>
                                  ...
                                  <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                      <textarea name="about" class="form-control" id="about" style="height: 100px; box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;margin-bottom:50px" required>{{ $category_room->mota }}</textarea>
